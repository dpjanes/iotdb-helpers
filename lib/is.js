...
exports.is = {
    ...
    Async: o => o[Symbol.toStringTag] === 'AsyncFunction',
...
Object.keys(exports.is)
    .forEach(m => exports.is[m].method = `_.is.${m}`)
...
/*
 *  new 2020-11 - rxjs support, a work in progress
 */
exports.is.rx = {
    Observable: o => lodash.isObject,
}
Object.keys(exports.is.rx)
    .forEach(m => exports.is.rx[m].method = `_.is.rx.${m}`)
