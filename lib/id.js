...
const _identifier_to_parts = function (identifier) {
    const _ = require("../helpers")
 ...
 */
const identifier_to_camel_case = function (identifier) {
    var parts = [];
 ...
 */
const identifier_to_dash_case = function (identifier) {
 ...
 */
const identifier_to_underscore_case = function (identifier) {
