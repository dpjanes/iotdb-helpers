...
const safe_encode = id => 
    "_" + (Buffer.from(id)).toString("hex");
const safe_decode = encoded_id => 
    encoded_id.startsWith("_") ? (Buffer.from(encoded_id.substring(1), "hex")).toString() : encoded_id;
