...
const _string_integer = (_value, otherwise) => {
...
const _string_number = (_value, otherwise) => {
...
const nulled = (s, otherwise) => {
    if (_.is.Undefined(otherwise)) {
        otherwise = null;
    }
