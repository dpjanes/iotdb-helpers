...
var _namespace = {
    "ow:": "http://www.w3.org/2002/07/owl#",
...
/**
 */
const _deepIndex = (vs, v) => {
    const _ = require("..")
    return _.findIndex(vs, p => _.isEqual(p, v))
}
            ...
            _.keys(o)
                .sort((a, b) => {
                    if (a.startsWith("@")) {
                        ...
                        return -1
                    } else if (b === "schema:name") {
                        return 1
                    } else if (a === "schema:identifier") {
                        return -1
                    } else if (b === "schema:identifier") {
                        return 1
                    } else {
                ...
                .forEach(key => {
                    nd[key] = _reorder(o[key])
                })

            return nd
        } else if (_.is.Array(o)) {
            return o.map(_reorder)
        } else {
            return o
        }
    }
